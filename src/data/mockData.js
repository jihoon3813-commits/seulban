...
export const PARTNER_LIST = [
  {
    ...
    tag: "24시간 응급",
    location: "서울 강남구 역삼동",
    benefit: "슬반생 회원 진료비 10% 지원 + 무료 기초상담",
    desc: "대학병원급 첨단 CT/MRI 장비 보유, 분과별 전문의 상주",
    rating: 4.9,
    reviews: 184,
    phone: "02-555-8275",
  ...
  },
  {
    ...
    tag: "저자극 스파",
    location: "경기 성남시 분당구",
    benefit: "스파 코스 무료 업그레이드 (탄산스파)",
    desc: "스트레스 없는 1:1 케어룸, 피부 타입별 천연 입욕제 사용",
    rating: 4.8,
    reviews: 142,
    phone: "031-712-4982",
    color: "bg-[#E8F7F3] text-[#0D9488]",
    icon: "scissors",
    featured: true,
  },
  {
    ...
    tag: "천연 잔디",
    location: "경기 용인시 수지구",
    benefit: "1박 투숙 시 프리미엄 에티켓 케어 무료",
    desc: "1,000평 규모 천연 잔디 운동장, 전문 훈련사 24시간 상주",
    rating: 5.0,
    reviews: 96,
    phone: "031-264-9988",
    color: "bg-[#FCECEE] text-[#E11D48]",
    icon: "home",
    featured: true,
  },
  {
