...
export const PawIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" {...props}>
    <ellipse cx="8.5" cy="5" rx="2" ry="2.8" />
    <ellipse cx="15.5" cy="5" rx="2" ry="2.8" />
    <ellipse cx="4.5" cy="10" rx="1.8" ry="2.5" />
    <ellipse cx="19.5" cy="10" rx="1.8" ry="2.5" />
    <path d="M12 11.5c-3.2 0-5.5 2.2-5.5 5 0 2.2 1.8 3.5 3.5 3.5 1.2 0 1.6-.7 2-.7s.8.7 2 .7c1.7 0 3.5-1.3 3.5-3.5 0-2.8-2.3-5-5.5-5z" />
  </svg>
);

export const PawOutlineIcon = ({ className = "w-7 h-7", ...props }) => (
  <svg 
    className={className} 
    viewBox="3 3 18 18" 
    fill="none" 
...
export const LogoEmblem = ({ className = "h-11 sm:h-12 w-auto", imgClassName = "h-full w-auto object-contain" }) => (
  <div className={`flex items-center justify-center shrink-0 ${className}`}>
    <img 
      src="https://res.cloudinary.com/lyjyvy54/image/upload/v1789272352/Group_2_5_l2foaz.png" 
      alt="슬반생 로고" 
...
export const MessageSquare = ({ className = "w-4 h-4" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ExternalLinkIcon = ({ className = "w-3.5 h-3.5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const FlowerIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
