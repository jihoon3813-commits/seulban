    ...
    <div className="w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-3 sm:pt-8">
        <div className="w-full overflow-hidden shadow-xs border border-[#E5DFD1]">
          <img
            src="https://res.cloudinary.com/lyjyvy54/image/upload/v1789268627/ChatGPT_Image_2026%EB%85%84_9%EC%9B%94_13%EC%9D%BC_%EC%98%A4%ED%9B%84_12_03_30_3_jtir5y.png"
            alt="반려생활 제휴처 배너"
      ...
      <div className="py-8 sm:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-6 sm:mb-10 space-y-2 sm:space-y-3">
          ...
          <p className="text-[11px] sm:text-sm text-[#61716A] leading-relaxed">
            슬반생이 직접 시설과 진료 환경을 확인하고 엄선한 동물병원, 미용실, 유치원입니다. 회원 특별 할인과 무료 서비스를 누려보세요.
          </p>
        </div>

        {/* Filter and Search Bar */}
        <div className="bg-white p-3.5 sm:p-6 border border-[#EAE3D6] shadow-xs mb-6 sm:mb-10 space-y-3 sm:space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-12 gap-2.5 sm:gap-3">
            ...
            <div className="sm:col-span-6 relative">
              ...
              <input
                ...
                placeholder="업체명 또는 진료과목 검색"
                className="w-full pl-10 pr-3 py-2 border border-gray-200 text-xs focus:border-[#144A42] focus:outline-none"
              />
            </div>
        ...
        {/* Results Count */}
        <div className="flex items-center justify-between text-[11px] sm:text-xs text-[#6B7973] mb-4 sm:mb-6">
          <span>총 <strong className="text-[#144A42] font-bold">{filtered.length}</strong>개의 제휴처</span>
          <span>정렬: 추천순</span>
        </div>
              ...
              >
                <div>
                  ...
                  <div className="p-4 sm:p-6 space-y-1.5 sm:space-y-3">
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-[#142C27] group-hover:text-[#144A42] transition">
                      {item.name}
                    </h3>
                    <p className="text-[11px] sm:text-xs text-[#63726C] line-clamp-2 leading-relaxed">
                      {item.desc}
                    </p>
                  </div>
                </div>
